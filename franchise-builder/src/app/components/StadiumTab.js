...
import {
  ...
  purchasePremiumSeating, generateNewStadiumNamingRightsOffer, clamp,
} from '@/lib/engine';
...
export default function StadiumTab({ fr, setFr, season }) {
  ...
  const [fundingTier, setFundingTier] = useState(0); // 0=none, 1=15%, 2=30%, 3=50%
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
            ...
            {!confirmUpgrade
              ? <button
                  ...
                  disabled={(fr.cash || 0) < nextTierData.upgradeCost || season < nextTierData.minSeason}
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <div className="card" style={{ padding: '10px 14px', flex: 1, minWidth: 140 }}>
            ...
            <button
              ...
              style={{ fontSize: '0.65rem', marginTop: 8 }}
              disabled={(fr.cash || 0) < 2}
